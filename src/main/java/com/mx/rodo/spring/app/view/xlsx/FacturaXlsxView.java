package com.mx.rodo.spring.app.view.xlsx;
...
import com.mx.rodo.spring.app.models.entity.ItemFactura;
...
public class FacturaXlsxView  extends AbstractXlsxView{
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		response.setHeader("Content-Disposition", "attachment; filename=\"facturaView\"");
